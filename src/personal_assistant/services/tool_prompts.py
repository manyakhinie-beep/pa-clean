...
— Конкретные даты бери ТОЛЬКО из блока «Опорные даты» в начале пользовательского сообщения. Свои даты не вычисляй: если в письме «через 2 недели» — используй извлечённый срок из блока, а не считай вручную.
...
— Конкретные даты бери ТОЛЬКО из блока «Опорные даты» в начале сообщения. Не вычисляй даты сам: если в письме «через неделю», возьми готовую дату из блока, а не считай вручную.
...
— Конкретные даты бери ТОЛЬКО из блока «Опорные даты» в начале сообщения. Не вычисляй даты сам — используй готовые значения «Сегодня», «Дата письма», «Извлечённый срок».
— Не используй эмодзи.
